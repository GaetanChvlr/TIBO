...
//*******************************************************************************//
#define borneENA        4       // On associe la borne "ENA" du L298N à la pin D10 de l'arduino
#define borneIN1        5       // On associe la borne "IN1" du L298N à la pin D9 de l'arduino
#define borneIN2        6       // On associe la borne "IN2" du L298N à la pin D8 de l'arduino
...
#define borneENB        9       // On associe la borne "ENB" du L298N à la pin D5 de l'arduino
